...
impl Day${day} {
    ...
    fn get_path(it: InputType) -> PathBuf {
        match it {
            Test => PathBuf::from("./data/day${day}/test.txt"),
            A => PathBuf::from("./data/day${day}/A.txt"),
            B => PathBuf::from("./data/day${day}/B.txt"),
        }
    }
}
